...
const upload = multer({ storage: multer.memoryStorage(), limits: { fileSize: 50 * 1024 * 1024 }, fileFilter: (_r, file, cb) => cb(file.mimetype === 'application/pdf' ? null : new Error('Only PDF files are allowed.')) });
