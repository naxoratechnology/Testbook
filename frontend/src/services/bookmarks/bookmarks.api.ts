...
export interface SavedQuestion extends BookmarkReference { _id: string; user: string; title: string; question: { text: string; options: string[]; marks: number; negativeMarks: number }; createdAt: string }
