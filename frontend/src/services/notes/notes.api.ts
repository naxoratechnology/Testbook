...
export interface AdminNote { _id: string; name: string; description: string; exam: string; subject: string; pdfUrl: string; pages: number; status: NotesStatus; createdAt: string }
