...
export function ThumbnailInput({ file, url, title, kind, onChange, onRemove, disabled }: { file: File | null; url?: string; title: string; kind: 'course' | 'test-series'; onChange: (file: File | null) => void; onRemove?: () => void; disabled?: boolean }) {
  ...
  const Thumbnail = kind === 'course' ? CourseThumbnail : TestSeriesThumbnail;
