...
import bookmarks from '../services/bookmarks/bookmarks.slice';
import questionReview from '../services/question-review/questionReview.slice';
export const store = configureStore({ reducer: { auth, courses, testSeries, notes, currentAffairs, notices, syllabus, previousPapers, students, settings, dashboard, bookmarks, questionReview } });
